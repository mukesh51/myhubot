...
myhubot is a chat bot built on the [Hubot][hubot] framework. 

# This app has been updated to talk to London's TFL service to get the underground status and also Weather API's to get weather information for your city.
